...
**[Morse code]** provides collection classes with several traversal and searching methods, and with the ability to sort. 
...
- Choose a directory
- Open a Terminal
- write: git clone git@github.com:zhorabay/Morse-code.git
- get into to directory "Morse-code"
- write: npm install
...
Feel free to check the [issues page](https://github.com/zhorabay/Morse-code/issues/)
